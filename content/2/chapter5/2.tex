...
\subsubsubsection{5.2.1\hspace{0.2cm}Finding files and paths}
...
\subsubsubsection{5.2.2\hspace{0.2cm}Finding programs}
...
\subsubsubsection{5.2.3\hspace{0.2cm}Finding libraries}
